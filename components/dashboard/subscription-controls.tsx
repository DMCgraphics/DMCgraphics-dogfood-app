...
export function SubscriptionControls({
  ...
  const sampleDailyGrams = 160 // Sample for medium dog
  const packInfo = getPackPortion(sampleDailyGrams)
  const biweeklyPacks = Math.ceil((packInfo.packsPerMonth / 30) * 14) // 2-week delivery
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle>Subscription & Deliveries</CardTitle>
