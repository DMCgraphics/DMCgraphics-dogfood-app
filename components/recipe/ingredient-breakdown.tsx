...
const ingredientData: Record<string, Ingredient[]> = {
  "beef-quinoa-harvest": [
    ...
    { name: "Whole egg", percentage: 4, source: "Local & Regional Farms", benefits: ["Complete protein", "Biotin", "Choline"] },
    ...
    { name: "Spinach", percentage: 2, source: "Local & Regional Farms", benefits: ["Iron", "Folate", "Antioxidants"] },
    { name: "Green peas", percentage: 4, source: "Local & Regional Farms", benefits: ["Protein", "Fiber"] },
  ...
  "lamb-pumpkin-feast": [
    ...
    { name: "Whole egg", percentage: 5, source: "Local & Regional Farms", benefits: ["Complete protein", "Biotin", "Choline"] },
    { name: "Pumpkin", percentage: 15, source: "Local & Regional Farms", benefits: ["Digestive support", "Beta-carotene"] },
    { name: "Peas", percentage: 10, source: "Local & Regional Farms", benefits: ["Protein", "Fiber"] },
    { name: "Spinach", percentage: 5, source: "Local & Regional Farms", benefits: ["Iron", "Folate", "Antioxidants"] },
    { name: "Cod liver oil", percentage: 0.5, source: "IFOS-certified", benefits: ["EPA+DHA omega-3s", "Brain & heart health"] },
  ...
  "low-fat-chicken-garden-veggie": [
    ...
    { name: "Whole egg", percentage: 8, source: "Local & Regional Farms", benefits: ["Complete protein", "Biotin", "Choline"] },
    ...
    { name: "Green peas", percentage: 3, source: "Local & Regional Farms", benefits: ["Protein", "Fiber"] },
  ...
  "turkey-brown-rice-comfort": [
    ...
    { name: "Whole egg", percentage: 5, source: "Local & Regional Farms", benefits: ["Complete protein", "Biotin", "Choline"] },
    { name: "Brown rice", percentage: 18, source: "Organic Supplier", benefits: ["Complex carbs", "Steady energy"] },
    { name: "Carrots", percentage: 10, source: "Local & Regional Farms", benefits: ["Beta-carotene", "Eye health"] },
    { name: "Zucchini", percentage: 8, source: "Local & Regional Farms", benefits: ["Hydration", "Fiber"] },
    { name: "Spinach", percentage: 6, source: "Local & Regional Farms", benefits: ["Iron", "Vitamins"] },
    { name: "Cod liver oil", percentage: 0.5, source: "IFOS-certified", benefits: ["EPA+DHA omega-3s", "Brain & heart health"] },
