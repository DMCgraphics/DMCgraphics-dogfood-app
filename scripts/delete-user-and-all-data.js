 ...
 * This handles the foreign key constraint issues by deleting in the correct order
 */
...
async function deleteUserAndAllData(userEmail) {
  ...
  try {
    ...
    // 2d. Delete plans (they reference users and dogs)
    console.log('\n2d. Deleting plans...')
    ...
    // 2e. Delete dogs (they reference users)
    console.log('\n2e. Deleting dogs...')
...
rl.question('Are you sure you want to proceed? (yes/no): ', (answer) => {
  ...
  if (answer.toLowerCase() === 'yes') {
    deleteUserAndAllData(userEmail).catch(console.error)
  } else {
