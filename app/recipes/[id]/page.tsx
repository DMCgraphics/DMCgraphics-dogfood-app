...
export default function RecipePage({ params }: RecipePageProps) {
  ...
  const getRecipeImage = (recipeId: string) => {
    const imageMap: Record<string, string> = {
      "chicken-greens":
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/u1732343973_A_fresh_farm-to-bowl_dog_food_image_highlighting__bb1f7104-0ebe-4a36-8bf1-db5fe4c773b2_1-NnHMghkZqTeim8lAREbtyN0ZetzwXm.png",
      "beef-quinoa-harvest":
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <h1 className="font-manrope text-3xl lg:text-4xl font-bold">{recipe.name}</h1>
              <p className="text-lg text-muted-foreground">
                Premium {recipe.format} made with {recipe.sourcing[0].split(",")[0]} ingredients. Nutritionally complete
                and balanced for {recipe.aafcoLifeStage === "all" ? "all life stages" : recipe.aafcoLifeStage} dogs.
              </p>
            </div>
