...
export const mockRecipes: Recipe[] = [
  {
    ...
    allergens: ["chicken"],
    aafcoLifeStage: "all",
    sourcing: ["Sunrise Poultry Farm - Litchfield, CT", "Hudson Valley Organic - Rhinebeck, NY"],
  ...
  },
  {
    ...
    sourcing: [
      "Heritage Ranch - Dutchess County, NY",
  ...
  },
  {
    ...
    allergens: ["turkey"],
    aafcoLifeStage: "all",
    sourcing: ["Connecticut Turkey Ranch - Woodstock, CT", "Hudson Valley Harvest - Kingston, NY"],
