          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="font-serif text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
                Nutrition that puts your dog first
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Founded by veterinarians and pet nutrition experts, NouriPet was born from a simple belief: every dog
                deserves personalized nutrition that supports their unique health needs and lifestyle.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Dogs Fed</div>
                </div>
                <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-serif text-xl font-semibold mb-2">Michael Rodriguez</h3>
