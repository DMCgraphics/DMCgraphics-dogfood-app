...
-- This script will fix ALL constraints including the newly discovered tables
...
-- Remove ALL possible constraint variations for billing_customers table
DO $$ 
DECLARE
    constraint_name TEXT;
BEGIN
...
-- Remove ALL possible constraint variations for dog_metrics table
DO $$ 
DECLARE
    constraint_name TEXT;
BEGIN
...
-- Remove ALL possible constraint variations for plan_dogs table
DO $$ 
DECLARE
    constraint_name TEXT;
BEGIN
...
-- Remove ALL possible constraint variations for addresses table
DO $$ 
DECLARE
    constraint_name TEXT;
BEGIN
...
-- Remove ALL possible constraint variations for ai_recommendations table
DO $$ 
DECLARE
    constraint_name TEXT;
BEGIN
...
-- Create dog_metrics.dog_id constraint with CASCADE DELETE (if table exists)
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dog_metrics' AND table_schema = 'public') THEN
        ALTER TABLE dog_metrics ADD CONSTRAINT dog_metrics_dog_id_cascade_delete 
            FOREIGN KEY (dog_id) REFERENCES dogs(id) ON DELETE CASCADE;
        RAISE NOTICE 'Created dog_metrics constraint';
    END IF;
END $$;

-- Create plan_dogs.dog_id constraint with CASCADE DELETE (if table exists)
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'plan_dogs' AND table_schema = 'public') THEN
        ALTER TABLE plan_dogs ADD CONSTRAINT plan_dogs_dog_id_cascade_delete 
            FOREIGN KEY (dog_id) REFERENCES dogs(id) ON DELETE CASCADE;
        RAISE NOTICE 'Created plan_dogs constraint';
    END IF;
END $$;

-- Create plan_dogs.plan_id constraint with CASCADE DELETE (if table exists)
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'plan_dogs' AND table_schema = 'public') THEN
        ALTER TABLE plan_dogs ADD CONSTRAINT plan_dogs_plan_id_cascade_delete 
            FOREIGN KEY (plan_id) REFERENCES plans(id) ON DELETE CASCADE;
        RAISE NOTICE 'Created plan_dogs plan_id constraint';
    END IF;
END $$;
...
-- Create indexes for additional tables (if they exist)
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'billing_customers' AND table_schema = 'public') THEN
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'dog_metrics' AND table_schema = 'public') THEN
        CREATE INDEX IF NOT EXISTS idx_dog_metrics_dog_id ON dog_metrics(dog_id);
    END IF;
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'plan_dogs' AND table_schema = 'public') THEN
        CREATE INDEX IF NOT EXISTS idx_plan_dogs_dog_id ON plan_dogs(dog_id);
        CREATE INDEX IF NOT EXISTS idx_plan_dogs_plan_id ON plan_dogs(plan_id);
    END IF;
END $$;
...
WHERE tc.constraint_type = 'FOREIGN KEY' 
  AND (ccu.table_name = 'users' OR ccu.table_name = 'dogs' OR ccu.table_name = 'plans')
...
BEGIN
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Including: dogs, plans, plan_items, subscriptions,';
    RAISE NOTICE 'orders, billing_customers, dog_metrics, plan_dogs,';
    RAISE NOTICE 'addresses, and ai_recommendations tables.';
    RAISE NOTICE '========================================';
