...
DROP POLICY IF EXISTS "sel own weight" ON weight_logs;
DROP POLICY IF EXISTS "ins own weight" ON weight_logs;
DROP POLICY IF EXISTS "upd own weight" ON weight_logs;
DROP POLICY IF EXISTS "del own weight" ON weight_logs;

DROP POLICY IF EXISTS "sel own stool" ON stool_logs;
DROP POLICY IF EXISTS "ins own stool" ON stool_logs;
DROP POLICY IF EXISTS "upd own stool" ON stool_logs;
DROP POLICY IF EXISTS "del own stool" ON stool_logs;
