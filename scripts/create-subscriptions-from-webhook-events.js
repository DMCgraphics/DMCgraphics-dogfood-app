...
async function createSubscriptionsFromWebhookEvents() {
  console.log('🔧 Creating Subscriptions from Webhook Events...\n')
      ...
      if (planId) {
        ...
        if (planError) {
          ...
          if (planBySession) {
            ...
            // Create a placeholder plan ID
            actualPlanId = `plan_webhook_${Date.now()}`
            console.log(`   🔧 Using placeholder plan ID: ${actualPlanId}`)
          }
        } else {
...
createSubscriptionsFromWebhookEvents()
