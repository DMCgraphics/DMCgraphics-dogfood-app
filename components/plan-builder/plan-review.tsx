...
function PlanReviewInner({
  ...
  const addOnsCostPerMonth = selectedAddOnItems.reduce((total, addOn) => total + addOn.pricePerMonth, 0)
  const totalMonthlyCost = pricing.costPerMonth + addOnsCostPerMonth
...
ESTIMATED COST: $${totalMonthlyCost.toFixed(2)} per month
...
Generated by NouriPet - Fresh food, fully explained.
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">{dogProfile.name}'s Personalized Nutrition Plan</CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-3 gap-6 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-primary">${totalMonthlyCost.toFixed(0)}</div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {recipe.kcalPer100g} kcal per 100g • {recipe.format}
                  </p>
                </div>
          ...
          <CardContent className="space-y-3">
            {selectedAddOnItems.map((addOn) => (
              <div key={addOn.id} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="font-semibold">${addOn.pricePerMonth}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <div className="space-y-1">
            <div className="text-sm text-muted-foreground">Complete monthly nutrition cost breakdown</div>
            <div className="text-xs text-muted-foreground">
        ...
        <CardContent className="space-y-3">
          <div className="flex justify-between">
            ...
            <span>${pricing.costPerMonth.toFixed(2)}/month</span>
          </div>
          {selectedAddOnItems.map((addOn) => (
            <div key={addOn.id} className="flex justify-between">
              <span>{addOn.name}</span>
              <span>${addOn.pricePerMonth.toFixed(2)}/month</span>
            </div>
          ))}
          <Separator />
