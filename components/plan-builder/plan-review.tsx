  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {/* Primary Action - Always require authentication for subscription */}
        {isLastDog && (
          <>
            {isAuthenticated ? (
              <Button 
                ...
                size="lg"
              >
                Purchase Subscription - ${totalWeeklyCost.toFixed(2)}/week
              </Button>
            ) : (
              <div className="space-y-4">
                <div className="text-center p-4 bg-muted/30 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-3">
                    To purchase your personalized nutrition plan, please create an account or sign in.
                  </p>
                  {onCreateAccount && (
                    <Button 
