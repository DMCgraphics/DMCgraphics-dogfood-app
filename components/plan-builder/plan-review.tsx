    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">
            {dogProfile.name || 'Your Dog'}'s Personalized Nutrition Plan
            {totalDogs > 1 && (
      ...
      <div className="space-y-4">
        ...
        {isLastDog && (
          <Button
            onClick={() => {
              console.log("[v0] Checkout button clicked", { isAuthenticated, hasOnProceed: !!onProceedToCheckout, hasOnCreate: !!onCreateAccount })
              if (isAuthenticated) {
                console.log("[v0] User is authenticated, calling onProceedToCheckout")
                onProceedToCheckout()
              } else if (onCreateAccount) {
                console.log("[v0] User not authenticated, calling onCreateAccount")
                onCreateAccount()
              } else {
                console.error("[v0] No handler available for button click")
              }
            }}
          ...
          >
            {isAuthenticated
              ? `Proceed to Checkout - $${totalWeeklyCost.toFixed(2)}/week`
              : 'Sign Up to Continue'
            }
          </Button>
        )}
        ...
        {/* Secondary Actions */}
        <Button variant="outline" onClick={handleDownload} className="w-full flex items-center justify-center gap-2 bg-transparent">
